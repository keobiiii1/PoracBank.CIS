        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustomerID = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EntityType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CustomerCategories = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ...
                    SourceOfFunds = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerID = table.Column<long>(type: "bigint", nullable: false),
                    EntityType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CheckedAgainst = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    IsEmployee = table.Column<bool>(type: "bit", nullable: false),
                    IsDosri = table.Column<bool>(type: "bit", nullable: false),
                    IsRpt = table.Column<bool>(type: "bit", nullable: false),
                    Position = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    IsRelative = table.Column<bool>(type: "bit", nullable: false),
                    RelativeEmployeeName = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    RelativePosition = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    RelativeRelationship = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    IsEntityOwnedByEmployee = table.Column<bool>(type: "bit", nullable: false),
                    NatureOfWorkBusiness = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NatureOfWorkBusinessOther = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    IsOwnedByPEP = table.Column<bool>(type: "bit", nullable: false),
                    DocumentsPresented = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AdditionalDocuments = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DocumentsOther = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    SignatureAuthenticated = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VerifiedBy = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ApprovedBy = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    Remarks = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReviewerSignature = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ClientAcknowledgementID = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CustomerID = table.Column<long>(type: "bigint", nullable: false),
                    EntityType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    DateSigned = table.Column<DateOnly>(type: "date", nullable: true, defaultValueSql: "GETDATE()"),
                    IsAgreed = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientAcknowledgement", x => x.ClientAcknowledgementID);
                    table.ForeignKey(
                        name: "FK_ClientAcknowledgement_Customer_CustomerID",
                        column: x => x.CustomerID,
                        principalSchema: "cis",
                        principalTable: "Customer",
                        principalColumn: "CustomerID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceOfFunds = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelfieImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    SelfieContentType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    TINFrontImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    TINFrontContentType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    TINBackImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    TINBackContentType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    SSSFrontImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    SSSFrontContentType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    SSSBackImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    SSSBackContentType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    GSISFrontImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    GSISFrontContentType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    GSISBackImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    GSISBackContentType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    DriversLicenseFrontImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    DriversLicenseFrontContentType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    DriversLicenseBackImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    DriversLicenseBackContentType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    PassportFrontImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    PassportFrontContentType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    PassportBackImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    PassportBackContentType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    OtherIDFrontImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    OtherIDFrontContentType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    OtherIDBackImage = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    OtherIDBackContentType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaidenMiddleName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    MaidenLastName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    IsResident = table.Column<bool>(type: "bit", nullable: false),
                    IsGov = table.Column<bool>(type: "bit", nullable: false),
                    GovPosition = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    GovPeriod = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientAcknowledgement_CustomerID",
                schema: "cis",
